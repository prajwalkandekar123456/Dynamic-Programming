...
int tab(int n,vector<int> &prices,int k)
{
...
int opti(int n,vector<int> &prices,int k)
{
...
{
//     return recc(0,1,prices,k,n);
    vector<vector<vector<int>>> dp(n,vector<vector<int>>(2,vector<int>(k+1,-1)));
    return memo(0,1,prices,k,n,dp);
//     return tab(n,prices,k);
    // return opti(n,prices,k);
...
int main()
{
    ...
    Solution obj;
    int ans = obj.maxProfit(prices,n,k);
    cout<<ans<<endl;
    return 0;
}
